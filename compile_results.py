...
compile_results(data_path = 'data/output/training_data_tam.pkl', model = 'Results/models/best', include_text = 0 , output = "Results/data/training_df.xlsx")

compile_results(data_path = 'data/output/testing_data_tam.pkl', model = 'Results/models/best', include_text = 0 , output = "Results/data/testing_df.xlsx")
...
compile_results(data_path = 'data/output/training_data_tam.pkl', model = 'Results/models/best', include_text = 1 , output = "Results/data/with text/training_df.xlsx")

compile_results(data_path = 'data/output/testing_data_tam.pkl', model = 'Results/models/best', include_text = 1 , output = "Results/data/with text/testing_df.xlsx")
